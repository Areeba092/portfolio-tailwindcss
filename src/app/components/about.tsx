...
import img from "../../../public/picture/aboutss.jpg"
      ...
      <div
        ...
        <div className="lg:flex-grow md:w-[60%] lg:pl-14 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          ...
          <p className="font mb-8 leading-relaxed text-left ">
            ...
            I am B.com student. While I am studying in university,
            I we also developed a strong interest in web development. Currently,
            I am learning the essentials of HTML, CSS, and JavaScript, TypeScript
            TailwindCSS to create responsive and functional websites. Looking
            ahead, I am also planning to dive deeper into frameworks like React
            ...
            experiences. Let us collaborate and bring your ideas to life!
          </p>
